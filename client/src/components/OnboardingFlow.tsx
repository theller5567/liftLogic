...
const emptyAnswers: OnboardingAnswers = {
  ...
  recentTrainingConsistency: undefined,
  wantsRecommendationFineTuning: undefined,
  movementConfidence: undefined,
  jointConcerns: undefined,
  dislikedExerciseIds: undefined,
